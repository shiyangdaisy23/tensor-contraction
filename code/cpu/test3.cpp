...
int main()
{
  ...
  timeval tv1, tv2;
  FILE * result; 
  //ofstream fout("cpu_timing_dom_scifig.txt",ios::out|ios::app);
  result = fopen("result.txt","w"); 
  fprintf(result,"%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\t", "t_size\t","time_11_b_p", "time_11_b_n", "time_11_f", "time_12_b_p", "time_12_b_n", "time_21_b_p", "time_21_b_n", "time_21_f", "time_22_b_p", "time_22_b_n", "time_13_b_p", "time_13_geam", "time_15_b_p", "time_15_f", "time_51_b_n", "time_51_f", "time_61_b_n", "time_61_f");

  fprintf(result,"%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n", "time_11_pbyn", "time_11_nbyp", "time_12_pbyn", "time_12_nbyp", "time_21_pbyn", "time_21_nbyp", "time_22_pbyn", "time_22_nbyp", "time_11_fbyn", "time_11_nbyf", "time_11_fbyp", "time_11_pbyf", "time_21_fbyn", "time_21_nbyf", "time_21_fbyp", "time_21_pbyf", "time_15_fbyp", "time_15_pbyf", "time_51_fbyn", "time_51_nbyf", "time_61_fbyn", "time_61_nbyf", "time_13_trans_f", "time_13_trans_p", "time_13_trans_n"); // time of fancy derivatives

  #ifndef DOM_DEBUG
    dom_debug = 0;
    for(t_size=5; t_size<6; t_size++)
  #endif
  {
    ...
    fprintf(result,"%1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E\t", t_size, time_11_b_p, time_11_b_n, time_11_f, time_12_b_p, time_12_b_n, time_21_b_p, time_21_b_n, time_21_f, time_22_b_p, time_22_b_n, time_13_b_p, time_13_geam, time_15_b_p, time_15_f, time_51_b_n, time_51_f, time_61_b_n, time_61_f);

    fprintf(result, "%1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E %1.3E\n", time_11_b_p/time_11_b_n, time_11_b_n/time_11_b_p, time_12_b_p/time_12_b_n, time_12_b_n/time_12_b_p, time_21_b_p/time_21_b_n, time_21_b_n/time_21_b_p, time_22_b_p/time_22_b_n, time_22_b_n/time_22_b_p, time_11_f/time_11_b_n, time_11_b_n/time_11_f, time_11_f/time_11_b_p, time_11_b_p/time_11_f, time_21_f/time_21_b_n, time_21_b_n/time_21_f, time_21_f/time_21_b_p, time_21_b_p/time_21_f, time_15_f/time_15_b_p, time_15_b_p/time_15_f, time_51_f/time_51_b_n, time_51_b_n/time_51_f, time_61_f/time_61_b_n, time_61_b_n/time_61_f, time_13_geam+time_11_f, time_13_geam+time_11_b_p, time_13_geam+time_11_b_n); // time of fancy derivatives
  }
  fclose(result);
  return(0);
}
