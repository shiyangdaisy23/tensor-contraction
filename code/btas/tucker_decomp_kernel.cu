...
int main()
{
  ...
  ofstream fout("gputiming_serial_chrono_float_mklkernel.txt",ios::out|ios::app);
...
//  for (int iter = 0; iter <iter_max; iter++){
  ...
  cudaEventRecord()start;
    blast::batch_gemm(blast::cublas::par.with(&handle),blast::NoTrans,blast::NoTrans,I,Q,J,alpha,X,I,I*J,h_A2,J,0,beta,temp_1,I,I*Q,K);
blast::batch_gemm(blast::cublas::par.with(&handle),blast::NoTrans,blast::NoTrans,I,Q,K,alpha,temp_1,I,I*Q,h_A3,K,0,beta,Y1_eigen,I,I*Q,R);
...
////////////////////////////////////////////////////////////////////////////////////////////   
     /*    UPDATE A2    */ 
/* t1 = high_resolution_clock::now();
blast::batch_gemm(blast::cublas::par.with(&handle),blast::NoTrans,blast::NoTrans,I,J,K,alpha,X,I,I*J,h_A3,K,0,beta,temp_2,I,I*J,R);
blast::batch_gemm(blast::cublas::par.with(&handle),blast::Trans,blast::NoTrans,P,J,I,alpha,h_A1,I,0,temp_2,I,I*J,beta,Y2_eigen,P,P*J,R);
...
/////////////////////////////////////////////////////////////////////////////////////////////
 /*    UPDATE A3    */ 
/*  t1 = high_resolution_clock::now();
   blast::batch_gemm(blast::cublas::par.with(&handle), blast::Trans,blast::NoTrans,P,J,I,alpha,h_A1,I,0,X,I,I*J,beta,temp_3,P,P*J,K);
   blast::batch_gemm(blast::cublas::par.with(&handle), blast::NoTrans,blast::Trans,P,Q,J,alpha,temp_3,P,P*J,h_A2,J,0,beta,Y3_eigen,P,P*Q,K);
