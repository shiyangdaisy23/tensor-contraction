...
dot(const execution_policy<DerivedPolicy>& /*exec*/,
    ...
    ComplexFloat& result)
{
  BLAST_DEBUG_OUT("cblas_cdotc_sub");
...
{
  BLAST_DEBUG_OUT("cblas_zdotc_sub");
...
dotu(const execution_policy<DerivedPolicy>& /*exec*/,
     ...
     ComplexFloat& result)
{
  BLAST_DEBUG_OUT("cblas_cdotu_sub");
...
dotu(const execution_policy<DerivedPolicy>& /*exec*/,
     ...
     ComplexDouble& result)
{
  BLAST_DEBUG_OUT("cblas_zdotu_sub");
