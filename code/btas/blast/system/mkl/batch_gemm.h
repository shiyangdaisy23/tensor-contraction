...
batch_gemm(const execution_policy<DerivedPolicy>& /*exec*/,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cblas_sgemm_batch");
  BLAST_DEBUG_OUT_2(transA << " " << transB << "\n" <<
                      m << " " << n << " " << k << " " << p << "\n" <<
                      alpha << "\n" <<
                      A << " " << ldA << " " << loA << "\n" <<
                      B << " " << ldB << " " << loB << "\n" <<
...
batch_gemm(const execution_policy<DerivedPolicy>& /*exec*/,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cblas_dgemm_batch");
...
batch_gemm(const execution_policy<DerivedPolicy>& /*exec*/,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cblas_cgemm_batch");
...
batch_gemm(const execution_policy<DerivedPolicy>& /*exec*/,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cblas_zgemm_batch");
