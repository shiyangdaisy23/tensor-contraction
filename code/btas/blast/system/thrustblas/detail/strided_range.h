 ...
 *
 *  \code
 *  #include <blast/array1d.h>
 *  #include <blast/iterator/strided_range.h>
 *
 *  #include <iostream>
 *
 *  int main(void)
 *  {
 *    typedef blast::counting_array<int>::iterator Iterator;
 *
 *    blast::counting_array<int> a(30);
 *    blast::strided_range<Iterator> iter(a.begin(), a.end(), 5);
 *
