...
// XXX: Custom CUBLAS implementation of batch_gemm
...
batch_gemm(const execution_policy<DerivedPolicy>& exec,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cublasSgemmBatched");
...
batch_gemm(const execution_policy<DerivedPolicy>& exec,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cublasDgemmBatched");
...
batch_gemm(const execution_policy<DerivedPolicy>& exec,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cublasCgemmBatched");
...
batch_gemm(const execution_policy<DerivedPolicy>& exec,
           ...
           int p)
{
  BLAST_DEBUG_OUT("cublasZgemmBatched");
