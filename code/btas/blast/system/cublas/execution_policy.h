...
{
  static_assert(sizeof(DerivedPolicy) == 0, "BLAST UNIMPLEMENTED");
  return {};
}
...
struct execute_on_handle_base
    : public blast::cublas::execution_policy<DerivedPolicy>
{
  ...
  DerivedPolicy with(const cublasHandle_t& h) const
  {
    ...
    DerivedPolicy result = blast::detail::derived_cast(*this);
...
// Include algorithms
#include <blast/system/cublas/copy.h>
#include <blast/system/cublas/dot.h>

#include <blast/system/cublas/gemv.h>
#include <blast/system/cublas/ger.h>

#include <blast/system/cublas/gemm.h>

#include <blast/system/cublas/batch_gemm.h>
