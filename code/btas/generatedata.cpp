...
int main()
{
  ...
  ofstream fout("dataX20_10.txt",ios::out|ios::app);
  for(int i = 0; i<I*J*K;i++)
  {
    fout<<X[i]<<'\t';
  }
...
///////////////////////////////////////////////////////////////////////////////
 ...
 for(int i = 0; i<I; ++i){
  ...
  ofstream foutA1("dataA120_10.txt",ios::out|ios::app);
  for(int i = 0; i<I;i++)
  {	for(int j = 0; j<P;j++)
	{
       		foutA1<<A1(i,j)<<'\t';
 ...
 ofstream foutA2("dataA220_10.txt",ios::out|ios::app);
  for(int i = 0; i<J;i++)
  {	for(int j = 0; j<Q;j++)
	{
       		foutA2<<A2(i,j)<<'\t';
 ...
 ofstream foutA3("dataA320_10.txt",ios::out|ios::app);
  for(int i = 0; i<K;i++)
  {	for(int j = 0; j<R;j++)
	{
       		foutA3<<A3(i,j)<<'\t';
